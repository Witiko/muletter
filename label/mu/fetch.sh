...
../../fetch-pdf.sh \
 's#Univerzita–obecne#Ostatni-pracoviste/base#;
  ...
  s#.*/(.*)/.*/.*/[^_]*_stitek_outline_cz\.pdf$#filetter-$1-czech.pdf#;
  s#.*/(.*)/.*/.*/[^_]*_stitek_cz\.pdf$#filetter-$1-czech-color.pdf#;
  s#.*/(.*)/.*/.*/[^_]*_stitek_outline_en\.pdf$#filetter-$1-english.pdf#;
  s#.*/(.*)/.*/.*/[^_]*_stitek_en\.pdf$#filetter-$1-english-color.pdf#;' \
  /media/*/gdrive/MU-JVS-AKTUALIZACE2015/**/stitky/pdf-cmyk-*/*_stitek{,_outline}_{cz,en}.pdf
